#!/usr/bin/env python3
"""
Recuperation des codes promo Adidas depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/adidas.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/adidas.fr"
STORE_NAME = "Adidas"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Adidas depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-adidas)"
    }
    try:
